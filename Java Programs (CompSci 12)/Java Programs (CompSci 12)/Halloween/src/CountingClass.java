...
public class CountingClass {
	...
	public static void CountCrib(int [] Crib, int Flipped,int [] Value, int [] Value2) {
		int X=0,j=0,j1=0;
		int [] Crib1 = {0,0,0,0,0};
	...
	public static void CountHand(int [] Value, int [] Crib, int Flipped, int [] RandomCompCards2, int [] RandomCards2, 
